...
int TagIsActive(int verbose)
{
	...
	while (currentTag != NULL)
	{
		...
		case VTAG_DEFAULT:
			return 1;
		case VTAG_USER:
			return ConfigIsForUser(currentTag->data1, verbose);
		case VTAG_GROUP:
			return ConfigIsForGroup(currentTag->data1, verbose);
		case VTAG_RANGEIP:
			return ConfigIsForRangeIP(currentTag->data1, verbose);
		case VTAG_VIRTUALHOST:
			return ConfigIsForVirtualhost(currentTag->data1, currentTag->data2, verbose);
		}
